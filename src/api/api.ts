...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    jobs = {
         ...
         * @secure
         */
        jobsRead: (id: number, params: RequestParams = {}) =>
            this.request<void, any>({
                path: `/jobs/${id}/`,
                method: "GET",
                secure: true,
         ...
         * @secure
         */
        jobsUpdate: (id: number | undefined, data: Job, params: RequestParams = {}) =>
            this.request<Job, any>({
                path: `/jobs/${id}/`,
                method: "PUT",
                body: data,
         ...
         * @secure
         */
        jobsImageCreate: (id: number, params?: { body: FormData }) =>
            this.request<void, any>({
                path: `/jobs/${id}/image/`,
                method: "POST",
                body: params,
    ...
    printings = {
         ...
         * @secure
         */
        printingsList: (params?: { }, query?: { status?: string; start_date?: string; end_date?: string } ) =>
            this.request<void, any>({
                path: `/printings/`,
                method: "GET",
                query: query,
         ...
         * @secure
         */
        printingsCompleteCreate: (id: string, params?: { status: "complete" | "reject" }) =>
            this.request<void, any>({
